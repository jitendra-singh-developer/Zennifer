import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankingCustomerSummary_Case extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0ko78000000GnZvAAK"
                );
                this.loadCustomStylesheetAttachement("00P7800000GMhLCEA1");
