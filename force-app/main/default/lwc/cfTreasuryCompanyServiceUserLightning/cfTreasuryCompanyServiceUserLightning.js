import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfTreasuryCompanyServiceUserLightning extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG00000006tRYAQ"
                );
                this.loadCustomStylesheetAttachement("00PVG000002A8Kv2AK");
