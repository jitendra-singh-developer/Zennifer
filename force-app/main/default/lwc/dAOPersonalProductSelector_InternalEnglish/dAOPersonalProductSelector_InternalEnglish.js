...
import { OMNIDEF } from './dAOPersonalProductSelector_InternalEnglish_def.js';
import tmpl from './dAOPersonalProductSelector_InternalEnglish.html';
import tmpl_nds from './dAOPersonalProductSelector_InternalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dAOPersonalProductSelector_InternalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
