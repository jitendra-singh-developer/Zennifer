import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import { load } from "omnistudio/newportLoader";
          ...
          export default class cfDAOProducts_5_Gerent extends FlexCardMixin(LightningElement){
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  ...
                  " card-0ko78000000GnAvAAK"
                );
                this.loadCustomStylesheetAttachement("00P7800000DrGQlEAN");
