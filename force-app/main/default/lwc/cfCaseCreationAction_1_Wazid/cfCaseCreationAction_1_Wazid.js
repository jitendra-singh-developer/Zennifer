import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfCaseCreationAction_1_Wazid extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCaseCreationAction_1_Wazid';
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG00000009xlYAA"
                );
                this.loadCustomStylesheetAttachement("00PVG000001ygAI2AY");
