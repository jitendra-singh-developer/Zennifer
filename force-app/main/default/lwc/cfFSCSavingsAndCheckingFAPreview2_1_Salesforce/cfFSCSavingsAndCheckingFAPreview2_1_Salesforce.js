import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfFSCSavingsAndCheckingFAPreview2_1_Salesforce extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0ko78000000GnAMAA0"
                );
                this.loadCustomStylesheetAttachement("00P7800000E3IRTEA3");
            ...
            this.customEventName0 = interpolateWithRegex(`clickevent`,this._allMergeFields,this._regexPattern,"noparse");
