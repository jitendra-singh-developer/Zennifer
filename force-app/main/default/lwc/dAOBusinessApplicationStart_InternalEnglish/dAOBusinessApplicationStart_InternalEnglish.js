...
import { OMNIDEF } from './dAOBusinessApplicationStart_InternalEnglish_def.js';
import tmpl from './dAOBusinessApplicationStart_InternalEnglish.html';
import tmpl_nds from './dAOBusinessApplicationStart_InternalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dAOBusinessApplicationStart_InternalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
