import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankingCustomerQuickActions_47_Gerent extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG00000006S4YAI"
                );
                this.loadCustomStylesheetAttachement("00PVG000001hDZJ2A2");
