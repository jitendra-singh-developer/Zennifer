...
import { OMNIDEF } from './financialAccountsShowSelectedTransactionsEnglish_def.js';
import tmpl from './financialAccountsShowSelectedTransactionsEnglish.html';
import tmpl_nds from './financialAccountsShowSelectedTransactionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class financialAccountsShowSelectedTransactionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
