import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfProductApplicationCheckOrdersChild_1_Gerent extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfProductApplicationCheckOrdersChild_1_Gerent';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_CheckOrders`,this._allMergeFields,this._regexPattern,"noparse");
