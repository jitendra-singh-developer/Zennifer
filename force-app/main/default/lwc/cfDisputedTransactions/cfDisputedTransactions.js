import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfDisputedTransactions extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG00000006exYAA"
                );
                this.loadCustomStylesheetAttachement("00PVG000001zDXd2AM");
