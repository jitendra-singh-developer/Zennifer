...
import { OMNIDEF } from './dAOBusinessProductSelector_InternalEnglish_def.js';
import tmpl from './dAOBusinessProductSelector_InternalEnglish.html';
import tmpl_nds from './dAOBusinessProductSelector_InternalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dAOBusinessProductSelector_InternalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
