...
import { OMNIDEF } from './caseCreateActionEnglish_def.js';
import tmpl from './caseCreateActionEnglish.html';
import tmpl_nds from './caseCreateActionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreateActionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
