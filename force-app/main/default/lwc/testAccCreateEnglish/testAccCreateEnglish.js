...
import { OMNIDEF } from './testAccCreateEnglish_def.js';
import tmpl from './testAccCreateEnglish.html';
import tmpl_nds from './testAccCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testAccCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
