import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfProductApplicationDebitCardChild extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfProductApplicationDebitCardChild';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_debitcards`,this._allMergeFields,this._regexPattern,"noparse");
