import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankingCustomerSummary_37_Gerent extends FlexCardMixin(LightningElement){
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG00000006TdYAI"
                );
                this.loadCustomStylesheetAttachement("00PVG000002kBtl2AE");
