...
import { OMNIDEF } from './caseCreateActionBusinessEnglish_def.js';
import tmpl from './caseCreateActionBusinessEnglish.html';
import tmpl_nds from './caseCreateActionBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreateActionBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
