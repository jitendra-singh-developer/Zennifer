...
import { OMNIDEF } from './dAOPersonalApplication_InternalEnglish_def.js';
import tmpl from './dAOPersonalApplication_InternalEnglish.html';
import tmpl_nds from './dAOPersonalApplication_InternalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dAOPersonalApplication_InternalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
