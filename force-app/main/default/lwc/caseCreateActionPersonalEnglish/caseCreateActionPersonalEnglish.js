...
import { OMNIDEF } from './caseCreateActionPersonalEnglish_def.js';
import tmpl from './caseCreateActionPersonalEnglish.html';
import tmpl_nds from './caseCreateActionPersonalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreateActionPersonalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
