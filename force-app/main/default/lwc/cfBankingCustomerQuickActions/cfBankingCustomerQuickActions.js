import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankingCustomerQuickActions extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfBankingCustomerQuickActions';
 ...
 this.registerEvents();
                this.setAttribute(
                  ...
                  " card-0koVG0000000841YAA"
                );
                this.loadCustomStylesheetAttachement("00PVG000001lYQf2AM");
