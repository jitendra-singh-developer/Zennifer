...
import { OMNIDEF } from './relationshipDocuSignEnglish_def.js';
import tmpl from './relationshipDocuSignEnglish.html';
import tmpl_nds from './relationshipDocuSignEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class relationshipDocuSignEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
