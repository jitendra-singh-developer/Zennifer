...
import { OMNIDEF } from './caseCreate2English_def.js';
import tmpl from './caseCreate2English.html';
import tmpl_nds from './caseCreate2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseCreate2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
