...
import { OMNIDEF } from './dAOProductRecommendationEnglish_def.js';
import tmpl from './dAOProductRecommendationEnglish.html';
import tmpl_nds from './dAOProductRecommendationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dAOProductRecommendationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
