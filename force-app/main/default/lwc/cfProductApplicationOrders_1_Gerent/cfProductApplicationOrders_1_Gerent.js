import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfProductApplicationOrders_1_Gerent extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfProductApplicationOrders_1_Gerent';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`updateCheckOrder`,this._allMergeFields,this._regexPattern,"noparse");
